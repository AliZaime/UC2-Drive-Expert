...
from .prompts import PROFILING_SYSTEM_PROMPTS
...
class CustomerProfilingAgent:
    ...
    async def analyze_profile(self, 
        ...
        system_instruction = PROFILING_SYSTEM_PROMPTS.get(language, PROFILING_SYSTEM_PROMPTS["fr"])
